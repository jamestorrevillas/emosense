...
import { ProjectTabList } from "@/components/videoReview/VideoReviewTabList";
import { ProjectListSkeleton } from "@/components/videoReview/VideoReviewListSkeleton";
...
export const VideoReviewListPage = () => {
  const { user } = useAuth();
    ...
    return (
      <div className="container py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold tracking-tight mb-1">Video Review Projects</h1>
            <p className="text-slate-600">
              Manage your video review projects and view feedback
            </p>
          </div>
